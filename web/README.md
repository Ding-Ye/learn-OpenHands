...
Next.js 15 doc viewer for learn-OpenHands. Static site that reads `../docs/{zh,en}/*.md` at build time and renders the curriculum side-by-side in two languages.
...
- 上游片段：`../upstream-readings/<file>.py`，由 `web/components/UpstreamReader.tsx` 读取。
