    ...
    <div className="min-h-screen flex">
      <aside className="w-72 shrink-0 border-r border-[var(--border)] bg-[var(--bg)] sticky top-0 h-screen overflow-y-auto p-5">
        ...
        <div className="mt-8 text-xs text-[var(--fg-muted)] leading-relaxed">
          {l === "zh"
            ? "用 Go 从零渐进重建 OpenHands 的 agent 服务端核心。每节末尾对照上游 Python 源码。"
            : "Rebuild the core of OpenHands' agent server in Go, chapter by chapter. Each chapter ends with an upstream Python source reading."}
        </div>
      </aside>
