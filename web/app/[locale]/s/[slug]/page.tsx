...
function guessUpstreamFile(slug: string): string | null {
  ...
  const map: Record<string, string> = {
    "s01-event-store": "s01-event-store.py",
    "s02-conversation-lifecycle": "s02-conversation-lifecycle.py",
    "s03-pending-messages": "s03-pending-messages.py",
    "s04-event-callbacks": "s04-event-callbacks.py",
    "s05-skill-loader": "s05-skill-loader.py",
    "s06-sandbox-runner": "s06-sandbox-runner.py",
    "s07-hook-loader": "s07-hook-loader.py",
    "s08-secrets-service": "s08-secrets-service.py",
    "s09-file-store": "s09-file-store.py",
    "s10-live-status": "s10-live-status.py",
    "s11-git-integration": "s11-git-integration.py",
    "s12-mcp-service": "s12-mcp-service.py",
    "s13-integrations": "s13-integrations.py",
    "s14-user-auth": "s14-user-auth.py",
  };
